...
const DrawerContentQuiz = ({ questionIds, onOpenChange }: DrawerContentQuestionProps) => {
      ...
      >
        <AnimatePresence>
          {questions.map((question: Question, index: number) => {
            ...
            const sectionTitle = question.question?.substring(0, 50) + (question.question?.length > 50 ? '...' : '') || `Question ${index + 1}`;
                  ...
                  >
                    ...
                    <AccordionContent className="pt-2 pb-4 space-y-4">
                        ...
                        <div className="border-l-4 border-gray-100 mx-4 pl-4 text-xs">
                          ...
                          <div className={`${
                            ...
                            <div className={`${isCorrect
                                    ? "bg-green-50 border-green-200 text-green-600"
                                    : "bg-red-50 border-red-200 text-red-600"} flex gap-2`}>
                              {isCorrect ? (
                                <Check className="w-4 h-4" />
                              ) : (
                                <X className="w-4 h-4" />
                      ...
                      {question.explanation && (
                        <div className="mx-4">
                          <EnhancedExplanation explanation={question.explanation} />
                        </div>
                      )}
                    </AccordionContent>
                  </Card>
...
export default DrawerContentQuiz;